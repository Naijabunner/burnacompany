...
const Hero = () => {
 ...
 <div className='text max-w-[640px] mx-auto space-y-1'>
        <h1 className='text-5xl md:text-6xl font-bold leading-[60px] md:leading-[80px] '>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Neque, explicabo!</h1>
        <p className=' font-medium text-lg md:text-xl opacity-60'>Lorem ipsum, dolor sit amet consectetur adipisicing.</p>

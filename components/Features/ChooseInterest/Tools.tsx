...
return (
  <section
    ...
    className="border border-[#d1d4db] justify-center min-h-60 px-5 py-6 rounded-lg cursor-pointer hover:shadow-2xl group transition-all ease-in-out hover:border-none"
  >

...
const customerReviews=[
  {
    profilePhoto:'',
    comment:" Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatum repudiandae distinctio doloribus minus placeat ad mollitia  dignissimos accusamus eum porro?",
    lastName:'LAstname',
    firstName:'firstnaem',
...
const UsersPage = () => {
  return (
    <section className=' min-h-[600px] px-5  !py-20 sm:p-10 bg-slate-700'>
      <h5 className=' pb-10 text-3xl md:text-5xl font-semibold text-center text-white'>
      See what our <span className=' strike relative z-50 '>trusted</span> users Say
      </h5>
      <Swiper
        slidesPerView={1}
        spaceBetween={10}
